...
</br>**!lb addbots** - This tells my mod to spawn bots on the ship. This command only works while the ship is in orbit and you must have **Allow bots in orbit** set to true. (YOU MUST HAVE NavmeshInCompany AS WELL!)
